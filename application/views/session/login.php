...
<div class="page login-page mt-5 pt-5">
    <div class="container-fluid d-flex align-items-center border border-dark">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="content mt-5 pt-5">
                            ...
                            <p class="text-center">
                                ...
                                d'administration de l'application d'auto-depistage.
                                Seuls les utilisateus et les administrateurs prealablement creer ont acces.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="container-fluid">
                                    ...
                                    <form class="" action="<?= base_url() . 'secure/login' ?>" method="post">
                                        ...
                                        <div class="form-group">
                                            <div class="md-form">
                                                <input type="text" id="username" name="username" class="form-control"
                                                       placeholder="Nom utilisateur" autofocus
                                        ...
                                        <div class="text-center">
                                            <input class="btn btn-primary btn-block" type="submit"
                                                   value="Se connecter"/>
                                            <hr>
                                            <small>Avez-vous perdu votre mot de passe ? reinitialiser-le par ici
                                                <a href="<?= base_url('secure/resetPassword'); ?>"
                                                   class="forgot-pass signup font-weight-bold">Mot
                                                    de
                                                    passe oublie ?</a>
                                                . Agile Sante vous permet de mettre en valeur vos competences dans le
                                                domaine
                                                medical.
                                            </small>
                                        </div>
                            ...
                            <?php } else { ?>
                                <div class="text-justify">
                                    <h5>Bienvenue dans l'application de gestion de structures medicales (Cabinets,
                                        etablissements, cliniques
                                        ainsi que le managment de systèmes d'information des hopitaux.
                                        Veuillez configurer le compte administrateur pour démarrer l'application <b>
                                        </b>.</h5>
                                </div>
                                <div class="card-footer btn-primary text-center">
                                    <a href="<?php echo base_url(); ?>" class="btn btn-success"
                                       data-toggle="modal" data-target=".modal-abonnement">Configurer compte
                                        administrateur
