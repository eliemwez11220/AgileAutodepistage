...
<div class="card blue-grey">
    <div class="card-header info-color-dark text-center white-text pt-5 mt-5">
        <h3 class="h5 text-uppercase font-weight-bold">
            Infos a la une - Bienvenue sur le site officiel de la plateforme de d'auto-depistage de la pandemie a COVID-19. Projet d'identification des individus
        ...
        <section>
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <div class="card blue-grey  text-white mb-4 wow fadeIn">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="font-weight-bold">Galerie publications </h3>
                        </div>
                        <div class="card-body">
                            <!-- Logo carousel -->
                    ...
                    <div class="card mb-4 wow fadeIn">
                        ...
                        <div class="card-header blue-grey  text-white">Dernieres publications</div>
            ...
            <div class="row wow fadeIn">
                ...
                <div class="col-lg-5 col-xl-4 mb-4">
                    ...
                    <div class="rounded z-depth-1-half">
                        <div class="overlay"
                             style="background-image: url(<?= base_url(''); ?>resources/front/img/posts/003.jpg)">
                ...
                <div class="col-lg-7 col-xl-7 ml-xl-4 mb-4">
                    ...
                    <p class="grey-text">Get started with MDBootstrap, the world's most popular Material Design
                        framework
                        for
                        building responsive,
                    ...
                    <a href="https://www.youtube.com/watch?v=cXTThxoywNQ" target="_blank"
